...
// this is the part of the original game i dont like, its gonna be reeeeee-worked
...
enum SeedType
{
    ...
    SEED_COBCANNON = 47,
    SEED_IMITATER = 48,
    SEED_EXPLODE_O_NUT=-23,
    SEED_GIANT_WALLNUT=-24,
    SEED_SPROUT=-25,
    SEED_LEFTPEATER=-26,
    ...
    SEED_ZOMBIE_IMP=-22,
    SEED_NONE = -1,
    VANILLA_NUM_SEED_TYPES=53,
    VANILLA_NUM_SEEDS_IN_CHOOSER=49,
};


#define NUM_SEED_TYPES Functions::getSeedTypes(true)
#define NUM_SEEDS_IN_CHOOSER Functions::getSeedTypes(true)
#define NUM_SEEDS_WITHOUT_UPGRADES 40
